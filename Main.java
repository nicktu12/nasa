...
// Java dependancies to read JSON
...
public class Main {
    ...
    {								 // This class was 
        ...
        try 
        {
            URLConnection conn = new URL("https://api.nasa.gov/planetary/apod?api_key=FGXgK4A9cKlD4DfNMrmbFgg7hsKGbn9FgZTRUt6O").openConnection();
			
			Object obj = new JSONParser().parse(new FileReader("conn"));
			JSONObject jo = (JSONObject) obj;
			imagelink= (String) jo.get("hdurl");
